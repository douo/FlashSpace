    ...
    var body: some View {
        Form {
            ...
            Group {
                ...
                Section {
                    hotkey("Focus Next Screen", name: .focusNextScreen, for: $settings.focusNextScreen)
                    hotkey("Focus Previous Screen", name: .focusPreviousScreen, for: $settings.focusPreviousScreen)
                }
